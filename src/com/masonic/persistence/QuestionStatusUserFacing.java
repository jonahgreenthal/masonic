 ...
 *
 * <p>This interface was automatically generated to represent objects loaded from {@code question_status}.  Do not modify this class directly; instead, alter the permanent storage on which it is based, the Opal configuration file for the project, and/or the {@link com.masonic.application.QuestionStatus}, and then regenerate the opals.  Any changes made to this file will be lost if the opals are regenerated.</p>
 *
 * <p>To create objects of this type from persistent data, use one of the various {@code forXXX} methods on the {@link com.masonic.application.QuestionStatusFactory} factory class.  To create new instances, use the {@code create()} method on the factory.</p>
 *
 * <p>Objects that implement this interface must provide Opal thread semantics; among other things this means that all modification of such objects must be done with an active {@link com.opal.TransactionContext}.</p>
 *
 * <p>This interface is not meant to be referenced in user code.  Only the {@link com.masonic.application.QuestionStatus} and the {@link com.masonic.application.QuestionStatusFactory} class should be referenced directly.</p>
 *
 * @author		<a href="mailto:jonah@jonahgreenthal.com">Jonah Greenthal</a>
 */
public interface QuestionStatusUserFacing extends com.opal.IdentityUserFacing, Comparable<com.masonic.application.QuestionStatus> {
	...
	public com.masonic.application.QuestionStatus setCode(java.lang.String argCode);
	...
	public com.masonic.application.QuestionStatus setName(java.lang.String argName);
	...
	@com.opal.annotation.NotNull
	@com.opal.annotation.Length(maximum = 32L)
	public com.masonic.application.QuestionStatus setShortName(java.lang.String argShortName);
	 ...
	 */
	@com.opal.annotation.NotNull
	public com.masonic.application.QuestionStatus setSequence(java.lang.Integer argSequence);
	 ...
	 */
	public com.masonic.application.QuestionStatus setSequence(int argSequence);
	...
	public static class CodeComparator extends com.siliconage.util.NullSafeComparator<com.masonic.application.QuestionStatus> {
		...
		@Override
		public int compareInternal(com.masonic.application.QuestionStatus argFirst, com.masonic.application.QuestionStatus argSecond) {
	...
	public static class NameComparator extends com.siliconage.util.NullSafeComparator<com.masonic.application.QuestionStatus> {
	...
	public static class ShortNameComparator extends com.siliconage.util.NullSafeComparator<com.masonic.application.QuestionStatus> {
	...
	public static class SequenceComparator extends com.siliconage.util.NullSafeComparator<com.masonic.application.QuestionStatus> {
