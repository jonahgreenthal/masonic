...
public interface QuestionOpalFactory extends com.opal.OpalFactory<Question, QuestionOpal>, com.opal.OpalFactoryPolymorphicCreator<Question, QuestionOpal, com.masonic.application.QuestionType> {
	...
	QuestionOpal createAsSuperOpal(Question argUF);
