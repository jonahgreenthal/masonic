...
public class QuestionFactory extends com.opal.AbstractIdentityFactory<Question, QuestionOpal> {
	...
	*/
	...
	protected QuestionFactory(com.opal.IdentityOpalFactory<Question, QuestionOpal> argOpalFactory) {
