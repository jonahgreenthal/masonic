...
public class CategoryGroupFactory extends com.opal.AbstractIdentityFactory<CategoryGroup, CategoryGroupOpal> implements com.opal.FactoryCreator<CategoryGroup> {
	...
	*/
	...
	protected CategoryGroupFactory(com.opal.IdentityOpalFactory<CategoryGroup, CategoryGroupOpal> argOpalFactory) {
	...
	*/
	...
	public static final CategoryGroup MATH() { return getInstance().forCode("MATH"); }
	public static final CategoryGroup MISCELLANEOUS() { return getInstance().forCode("MISCELLANEOUS"); }
	public static final CategoryGroup SCIENCE() { return getInstance().forCode("SCIENCE"); }
	public static final CategoryGroup SOCIAL_STUDIES() { return getInstance().forCode("SOCIAL_STUDIES"); }
