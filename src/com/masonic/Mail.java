...
public final class Mail {
	...
	private static final String mySmtpServer = Validate.notNull(MasonicConfiguration.getInstance().getString("SMTP_SERVER"));
	private static final int mySmtpPort = MasonicConfiguration.getInstance().getInt("SMTP_PORT");
	private static final boolean mySmtpSsl = MasonicConfiguration.getInstance().getBoolean("SMTP_SSL");
	private static final String mySmtpUsername = Validate.notNull(MasonicConfiguration.getInstance().getString("SMTP_USERNAME"));
	private static final String mySmtpPassword = Validate.notNull(MasonicConfiguration.getInstance().getString("SMTP_PASSWORD"));
	private static final String myBounceAddress = Validate.notNull(MasonicConfiguration.getInstance().getString("SMTP_BOUNCE_ADDRESS"));
